###########################################################################################
#
# Script inspired by github.com/ACEsuit/mace/tools/compile.py
# Adaptation for MDFC model and comments: Virgile de Saint Blanquat
#
# This script is actually not used in the MDFC project, but it is kept here as it could be used to complile models in a better way.
# If you kow how compling works in PyTorch, you can use this script as a base to try to improve the performance of the MDFC compling.
# If you are searching for a exemple on how to do so, you should look in MACE for "torch.compile(prepare" iterations.
#
###########################################################################################
